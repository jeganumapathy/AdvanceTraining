...
public class SubArrayProblem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ans is " + sumOfLessThanB(input, 242));
    ...
    */
    public static ArrayList<ArrayList<Integer>> return2DSubarray(ArrayList<Integer> A) {
        double n = A.size();
     ...
     *
     * */
    public static int sumOfLessThanB(ArrayList<Integer> A, int B) {
        double n = A.size();
        int count = 0;
        for (int i = 0; i < n; i++) {
            for (int j = i; j < n; j++) {
